...
{
    //класс для управления сообщениями пользователя
    public class MessageService
    {
        IMessageRepository messageRepository;
        IUserRepository userRepository;

        //инициализация репозиториев для работы с данными сообщений и пользователей
        ...
        //получение входящих сообщений для пользователя по его идентификатору
        ...
        //получение исходящих сообщений для пользователя по его идентификатору
